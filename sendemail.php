...
<?php
  if (isset($_POST['submit'])) {
    ...
    if (empty($subject) && empty($text)) {
      ...
      echo '<p style="color:#FF0000">*You forgot the email subject and body.</p><br />';
      $output_form = true;
    }

    if (empty($subject) && (!empty($text))) {
      echo '<p style="color:#FF0000">*You forgot the subject line.</p><br />';
      $output_form = true;
    }

    if ((!empty($subject)) && empty($text)) {
      echo '<p style="color:#FF0000">You forgot the email body text.<br />';
      $output_form = true;
    }
  }
  else {
